...
## 阶段 7 之后 — 试玩反馈 + 坦克视觉（已完成）

试玩 4 条和坦克视觉 P0–P3 都已落地，不要重做。完整事实、本地拉分支命令、验收清单与可复制提示词在 `docs/NEXT_SESSION.md`。

新窗口：先贴项目宪法，再贴 `NEXT_SESSION.md` 里的 **提示词 A（本地验收）**。单测和肉眼通过之前不要开阶段 8，也不要升 24×24。
